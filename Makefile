...
################################################################################
# \copyright
# Copyright 2022-YEAR, Cypress Semiconductor Corporation (an Infineon company)
...
APPNAME=cce-mtb-psoc4-flash-and-chip-protection
...
LINKER_SCRIPT=./linkerscript/custom.ld
